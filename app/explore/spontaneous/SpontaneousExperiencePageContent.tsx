  ...
  return (
    <AnimatePresence mode="wait">
      ...
      >
        ...
        <div
          className={`absolute inset-y-0 right-0 z-30 flex h-full transition ${
        ...
        >
          <button
            ...
            className={`absolute left-[-3rem] top-6 hidden h-11 w-11 items-center justify-center rounded-full border border-gray-200 bg-white text-lg text-gray-900 shadow-lg transition hover:border-gray-300 hover:text-gray-700 md:flex ${
